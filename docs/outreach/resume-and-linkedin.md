...
>
> Stack: Python 3.11, PyTorch + PyTorch Geometric (GraphSAGE), sentence-transformers (semantic features), OpenAI + Anthropic SDKs (agent loop), boto3 (hardened collectors), Next.js + Tailwind (web demo), Vercel (hosting), Terraform (4-team labeled test environment), Docker + GitHub Actions (release pipeline). 14-command Python CLI.
>
